    ...
    if tools:
        ...
        async def list_tools() -> list[Tool]:
            ...
            for tool_def in tools:
                # Convert input_schema para JSON Schema format
                if isinstance(tool_def.input_schema, dict):
                    # verificar se it's already a JSON schema
                    if (
                    ...
                    # For TypedDict ou other types, criar basic schema
        ...
        async def call_tool(name: str, arguments: Dict[str, Any]) -> Any:
            ...
            # Convert resultado para MCP format
            # The decorator expects us para retorna the content, não a CallToolResult
            # It will wrap our retorna value in CallToolResult
            content = []
            ...
            # retorna just the content lista - the decorator wraps it
            return content
